...
bg_level3=PhotoImage(file="Images/level2.png")
...
# canvas_bg_level2 = canvas.create_image(1340,0,image=bg_level1,anchor=NW)
# canvas_bg_level2 = canvas.create_image(2400,0,image=bg_level1,anchor=NW)
